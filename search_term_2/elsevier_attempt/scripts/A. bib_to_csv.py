...
bibdata = parser.parse_file("search_term_2/elsevier_attempt/datasets/elsevier_information_management.bib")
...
print(res_df)
res_df.to_csv('search_term_2/elsevier_attempt/datasets/elsevier_table.csv',index=False)
