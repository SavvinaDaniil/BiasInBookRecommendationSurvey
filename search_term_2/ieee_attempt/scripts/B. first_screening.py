...
first_screening[first_screening[rel_col]=='Yes'].to_csv('search_term_2/ieee_attempt/datasets/first_screening_clean.csv', index=False)
first_screening[first_screening[rel_col]=='Keep'].to_csv('search_term_2/ieee_attempt/datasets/first_screening_clean_KEEPS.csv', index=False)